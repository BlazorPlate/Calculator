...
namespace Calculator
{
       ...
       public class Calculator
        {
            ...
            private string[] ToPolish()
            {
                ...
                foreach (var str in _parsed)
                {
                    ...
                    else
                    {
                        ...
                        {
                            while (stack.Count != 0 && GetPriority(str) <= GetPriority(stack.Peek()))
                            {
                                output[i++] = stack.Pop();
                            }
                            stack.Push(str);
            ...
            private double GetResult()
            {
                ...
                double result;
                if (!double.TryParse(stack.Peek(), out result))
                {
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Calculator calculator = new Calculator("((2+3)*2/2)^3*10/100");
